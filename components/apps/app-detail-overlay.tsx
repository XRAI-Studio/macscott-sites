  ...
  return (
    <div aria-label={`${app.title} app showcase`} aria-modal="true" className="app-overlay" ref={overlay} role="dialog" tabIndex={-1}>
      ...
      <div className={`app-runtime ${playable ? "playable" : "dormant"}`}>
        {playable && <iframe allow="camera 'none'; microphone 'none'; geolocation 'none'; payment 'none'; usb 'none'; clipboard-read 'none'; clipboard-write 'none'" referrerPolicy="no-referrer" sandbox="allow-scripts allow-same-origin allow-pointer-lock allow-popups" src={app.liveUrl} title={app.title} />}
